...
public class PreferenceConfiguration {
    ...
    private static final String SYNC_TOUCH_EVENT_PREF_STRING = "checkbox_sync_touch_event";
    ...
    private static final boolean DEFAULT_SYNC_TOUCH_EVENT = true;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.syncTouchEventWithDisplay = prefs.getBoolean(SYNC_TOUCH_EVENT_PREF_STRING, DEFAULT_SYNC_TOUCH_EVENT);
